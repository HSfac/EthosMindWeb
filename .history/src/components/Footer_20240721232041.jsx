...
import './Footer.css';
import logoBlack from '../assets/images/metamindlogoblack.svg'; // 로고 이미지 경로
    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section footer-logo-section">
          <img src={logo} alt="MetaMind Logo" className="footer-logo" />
          <h2 className="footer-title">MetaMind</h2>
      ...
      <div className="footer-bottom">
        <p>&copy; 2024 MetaMind. All rights reserved.</p>
      </div>
    </footer>
  );
}
