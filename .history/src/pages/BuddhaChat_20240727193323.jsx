  ...
  return (
    <main className="buddha-main">
      ...
      <section className="buddha-features">
        ...
        <p className="buddha-section-description">BuddhaChat uses AI to create interactive dialogue apps that let you chat with buddha, Explore their worldviews, ask them questions, and get personalized advice.</p>
