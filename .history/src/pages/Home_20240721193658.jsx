...
import philochatScreenshot from '../assets/images/ph-image-dl.png'; // 이미지 예시, 적절한 경로와 이미지로 교체해주세요
import buddhachatScreenshot from '../assets/images/buddha-hero-image.png'; // 이미지 예시, 적절한 경로와 이미지로 교체해주세요
import biblechatScreenshot from '../assets/images/jesus-image-dl.png'; // 이미지 예시, 적절한 경로와 이미지로 교체해주세요
