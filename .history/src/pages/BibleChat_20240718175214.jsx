...
import heroImage from '../assets/images/hero-image-bible.png';
...
import dialogueImage5 from '../assets/images/dialogue-image5.png';
        ...
        <div className="biblechat-dialogue-cards">
          <div className="biblechat-dialogue-card">
            ...
            <div className="biblechat-dialogue-info">
              ...
              <button className="biblechat-dialogue-button">Start...</button>
            </div>
          </div>
          <div className="biblechat-dialogue-card">
