  ...
  return (
    <main className="buddha-main">
      ...
      <section className="buddha-features">
        ...
        <p className="buddha-section-description">SaintsChat uses AI to create interactive dialogue apps that let you chat with historical figures, fictional characters, and more. Explore their worldviews, ask them questions, and get personalized advice.</p>
        <button className="buddha-learn-more-button">Learn more</button>
