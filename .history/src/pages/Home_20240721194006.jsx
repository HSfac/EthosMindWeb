    ...
    <main className="landing-page">
      ...
      <section className="hero" style={{ backgroundImage: `url(${heroImage})` }}>
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            ...
            <a href="#app-introduction" className="hero-button">Learn More</a>
          </div>
        </div>
      </section>

      {/* App Introduction Section */}
      <section id="app-introduction" className="app-introduction">
        <div className="app-intro-card">
          ...
          <Link to="/saintschat" className="learn-more-button">Learn More</Link>
        </div>
        ...
        <div className="app-intro-card">
          ...
          <Link to="/buddhachats" className="learn-more-button">Learn More</Link>
        </div>
        ...
        <div className="app-intro-card">
          ...
          <Link to="/biblechats" className="learn-more-button">Learn More</Link>
        </div>
      </section>
      ...
      <section className="detailed-app-section">
        <div id="philochat-detail" className="app-detail">
          ...
          <Link to="/download" className="download-button">Download Philochat</Link>
        </div>
        ...
        <div id="buddhachat-detail" className="app-detail">
          ...
          <Link to="/download" className="download-button">Download Buddhachat</Link>
        </div>
        ...
        <div id="biblechat-detail" className="app-detail">
          ...
          <Link to="/download" className="download-button">Download Biblechat</Link>
        </div>
      </section>
      ...
      <section className="cta-section">
        ...
        <div className="cta-buttons">
          <Link to="/download" className="cta-button">Sign Up</Link>
