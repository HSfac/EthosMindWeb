    ...
    <main className="buddha-main">
      <section className="buddha-hero" style={{ backgroundImage: `url(${buddhaImage})` }}>
        <div className="buddha-hero-content">
          ...
          <p className="buddha-hero-subtitle">Explore the wisdom of the Buddha and meditate together with our App "buddha chat"</p>
      ...
      <section className="buddha-features">
        ...
        <p className="buddha-section-description">BuddhaChat uses AI to create interactive dialogue apps that let you chat with buddha, Explore their worldviews, ask them questions, and get personalized advice.And meditaing your minds</p>
