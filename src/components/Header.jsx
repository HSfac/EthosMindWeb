...
import './Header.css';
import logoBlack from '../assets/images/metamindlogoblack.svg'; // 로고 이미지 경로에 맞게 수정하세요.
import logoWhite from '../assets/images/metamindlogowhite.svg'; // 로고 이미지 경로에 맞게 수정하세요.
    ...
    <header className="header">
      <div className="header-logo-container">
        <Link to="/" className="header-logo-link">
          ...
          />
          <h1 className="header-title">EthosMind</h1>
        </Link>
      </div>
      <nav className="nav">
